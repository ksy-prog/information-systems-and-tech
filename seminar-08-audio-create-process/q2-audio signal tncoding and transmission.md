...
Процесс преобразования аналоговый звуковой сигнала (непрерывные изменения напряжения) в цифровую форму (последовательность нулей и единиц) называется **импульсно-кодовой модуляцией (ИКМ, PCM)**.
